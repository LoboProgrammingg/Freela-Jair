...
urlpatterns = [
    ...
    path('funcionarios/historico-pagamentos/', HistoricoPagamentosView.as_view(), name='historico-pagamentos'),
    path('funcionarios/<int:pk>/confirmar-pagamento/', confirmar_pagamento, name='confirmar-pagamento'),
